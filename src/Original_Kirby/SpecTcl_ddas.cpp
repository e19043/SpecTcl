...
//#include "../SpecTk/Server/server31.h"

betadecay bdecay("bdecay");
Nero nero("nero");
betadecayvariables bdecayv("bdecayv");
nerovariables nerov("nerov");
gammadecay gdecay("gdecay");
gammavariables gammav("gammav");
...
{ 
  RegisterEventProcessor(UnpackBDecay, "Unpack");
  RegisterEventProcessor(CalibrateBDecay, "Calibrate");
  RegisterEventProcessor(ThresholdBDecay, "Threshold");
  //  RegisterEventProcessor(CorrelatorBDecay, "Correlator");
  RegisterEventProcessor(CorrelatorBDecay, "CorrelatorSuN");
}  
